	...
	async execute(interaction) {
		const faqEmbed = new EmbedBuilder()
			...
			.addFields(
				...
				{ name: 'When should I take my second rest day?', value: '*This depends highly on what is valued during the current week and day. Look ahead and see if there are weak days you can skip. If you don\'t like the uncertainty of Day 2 predictions, it is a decent choice.*' },
